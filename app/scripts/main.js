...
(function() {
    ...
    var QRCodeManager = function(element) {
        ...
        var qrDecodeWorker = new Worker("scripts/jsqrcode/qrworker.js");
        var self = this;
        ...
        this.detectQRCode = function(imageData, callback) {
            ...
            */
            ...
            // call a webworker to decode the imagedata
            qrDecodeWorker.postMessage(imageData);

            qrDecodeWorker.onmessage = function(result) {
                var url = result.data;
                //console.log(result) ;
                if (url !== undefined) {
                    self.currentUrl = url;
            ...
            qrDecodeWorker.onerror = function(error) {
